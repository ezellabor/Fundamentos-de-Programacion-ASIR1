...
1. ¿Qué es el JDK?
   ...
   *Correcta: B. El JDK (Java Development Kit) incluye el compilador y las herramientas necesarias para programar en Java, además del entorno de ejecución.*
...
2. ¿Cómo se llama el método por el que empieza a ejecutarse un programa Java?
   ...
   *Correcta: C. La ejecución de un programa Java comienza siempre por el método main().*
...
3. ¿Cuál de estos es un tipo de dato primitivo en Java?
   ...
   *Correcta: B. int es un tipo primitivo; String, ArrayList y Scanner son clases.*
...
4. ¿Qué palabra clave se usa para declarar una constante en Java?
   ...
   *Correcta: C. final se usa para declarar valores que no pueden modificarse tras su inicialización.*
...
5. ¿Qué imprime System.out.println("Hola" + 5 + 2);?
   ...
   *Correcta: A. Al concatenar con un String, los siguientes valores se convierten también a texto: "Hola"+5+2 = "Hola52".*
...
6. ¿Qué clase se utiliza habitualmente para leer datos del teclado en Java?
   ...
   *Correcta: B. La clase Scanner (java.util) permite leer datos introducidos por teclado.*
...
7. ¿Qué tipo de dato usarías para almacenar el precio 45.90?
   ...
   *Correcta: C. double es el tipo adecuado para números decimales como un precio.*
...
8. ¿Qué hace el método nextInt() de Scanner?
   ...
   *Correcta: B. nextInt() lee específicamente un valor entero desde la entrada estándar.*
...
9. ¿Cuál es el resultado de 7 / 2 en Java, si ambos son de tipo int?
   ...
   *Correcta: B. La división entre enteros en Java descarta la parte decimal: 7/2 da 3.*
...
10. ¿Qué formato usa printf para mostrar un número decimal con dos decimales?
   ...
   *Correcta: C. %.2f indica un número en coma flotante con dos decimales.*
...
11. ¿Cómo se escribe un comentario de una sola línea en Java?
   ...
   *Correcta: B. Los comentarios de una línea en Java se escriben con //.*
...
12. ¿Qué extensión tiene el archivo compilado (bytecode) de una clase Java?
   ...
   *Correcta: C. El compilador javac genera archivos .class con el bytecode, que ejecuta la JVM.*
...
1. ¿Qué estructura se usa para ejecutar un bloque de código solo si se cumple una condición?
   ...
   *Correcta: B. if ejecuta un bloque de código cuando la condición es verdadera.*
...
2. ¿Qué devuelve la expresión (5 > 3) && (2 > 4)?
   ...
   *Correcta: B. && exige que ambas condiciones sean verdaderas; la segunda es falsa, así que el resultado es false.*
...
3. En una sentencia switch, ¿qué hace la instrucción break?
   ...
   *Correcta: B. break interrumpe la ejecución del switch, evitando que continúe con los siguientes case.*
...
4. ¿Qué ocurre si se olvida el break en un case de un switch?
   ...
   *Correcta: B. Sin break, la ejecución "cae" al siguiente case (fall-through) y también lo ejecuta.*
...
5. ¿Cuál es la sintaxis correcta del operador ternario?
   ...
   *Correcta: A. El operador ternario tiene la forma condición ? valorSiVerdadero : valorSiFalso.*
...
6. ¿Cuál de estos operadores es de igualdad en Java?
   ...
   *Correcta: B. == compara igualdad de valores; = es el operador de asignación.*
...
7. int x = 4; if (x > 5) {"A"} else if (x > 2) {"B"} else {"C"} ¿Qué se muestra?
   ...
   *Correcta: B. x=4 no es mayor que 5 pero sí mayor que 2, así que se ejecuta el bloque "B".*
...
8. ¿Qué tipo de dato debe tener la condición de un if en Java?
   ...
   *Correcta: B. En Java la condición de un if debe ser obligatoriamente de tipo boolean.*
...
9. ¿Qué hace el operador lógico ! (negación)?
   ...
   *Correcta: B. El operador ! invierte true a false y viceversa.*
...
10. ¿Cuándo es preferible un switch frente a una cadena de if-else?
   ...
   *Correcta: B. switch resulta más legible cuando se comparan muchos valores posibles de una misma variable.*
...
1. ¿Qué diferencia principal hay entre while y do-while?
   ...
   *Correcta: B. En do-while el bloque se ejecuta primero y la condición se comprueba después, por lo que se ejecuta al menos una vez.*
...
2. ¿Cuántas veces se ejecuta for (int i = 0; i < 5; i++) {...}?
   ...
   *Correcta: B. i toma los valores 0,1,2,3,4: son 5 iteraciones.*
...
3. ¿Qué provoca un bucle infinito?
   ...
   *Correcta: A. Si la condición de salida nunca se vuelve falsa, el bucle no termina nunca.*
...
4. En for (int i=0; i<10; i++), ¿qué se ejecuta tras cada vuelta del bloque?
   ...
   *Correcta: B. Tras cada ejecución del bloque, se aplica el incremento y después se comprueba la condición.*
...
5. ¿Qué es un acumulador en un bucle?
   ...
   *Correcta: B. El acumulador va guardando la suma (u otra operación) de los valores procesados en cada vuelta.*
...
6. ¿Qué es un bucle anidado?
   ...
   *Correcta: B. Un bucle anidado es aquel que se define dentro del cuerpo de otro bucle.*
...
7. ¿Qué hace continue dentro de un bucle?
   ...
   *Correcta: B. continue salta directamente a la siguiente iteración, sin ejecutar el resto del código de la actual.*
...
8. ¿Qué estructura es más adecuada cuando se conoce de antemano el número de repeticiones?
   ...
   *Correcta: C. for está pensado especialmente para cuando se conoce el número de iteraciones de antemano.*
...
9. ¿Qué ocurre si la condición de un while es falsa desde el principio?
   ...
   *Correcta: B. while comprueba la condición antes de cada ejecución, así que si es falsa desde el inicio, el bloque no se ejecuta.*
...
10. En un menú repetitivo con do-while, ¿qué condición suele usarse para salir?
   ...
   *Correcta: A. Lo habitual es repetir el menú hasta que el usuario elija explícitamente la opción de salir.*
...
1. ¿Cómo se declara un array de 5 enteros en Java?
   ...
   *Correcta: B. La sintaxis correcta es int[] array = new int[5];*
...
2. ¿Cuál es el índice del primer elemento de un array en Java?
   ...
   *Correcta: C. En Java los arrays se indexan comenzando por 0.*
...
3. ¿Qué excepción se produce al acceder a un índice fuera del rango de un array?
   ...
   *Correcta: B. Acceder a una posición que no existe lanza ArrayIndexOutOfBoundsException.*
...
4. ¿Qué ventaja principal tiene ArrayList frente a un array tradicional?
   ...
   *Correcta: B. A diferencia de los arrays de tamaño fijo, un ArrayList puede crecer o reducirse en tiempo de ejecución.*
...
5. ¿Qué método se usa para añadir un elemento a un ArrayList?
   ...
   *Correcta: C. El método add() añade un nuevo elemento al final de un ArrayList.*
...
6. ¿Qué tipo de dato se debe usar en un ArrayList para almacenar enteros?
   ...
   *Correcta: B. ArrayList no admite tipos primitivos directamente; hay que usar su clase envoltorio, Integer.*
...
7. ¿Qué hace un bucle for-each sobre una colección?
   ...
   *Correcta: A. El for-each simplifica el recorrido de colecciones, sin manejar un contador de índice.*
...
8. ¿Qué devuelve el método size() de un ArrayList?
   ...
   *Correcta: B. size() devuelve el número de elementos actualmente almacenados.*
...
9. ¿Cómo se elimina el elemento en la posición 2 de un ArrayList llamado lista?
   ...
   *Correcta: B. El método remove(indice) elimina el elemento situado en esa posición.*
...
10. ¿Qué representan tres ArrayList "paralelos" (nombres, precios, stocks) en el mismo índice i?
   ...
   *Correcta: B. En listas paralelas, la posición i de cada lista corresponde a un mismo elemento.*
...
11. ¿Por qué conviene sustituir las listas paralelas por una clase Producto en la siguiente UT?
   ...
   *Correcta: B. Agrupar los datos relacionados en una clase evita tener que mantener sincronizadas varias listas.*
...
1. ¿Qué palabra indica que un método no devuelve ningún valor?
   ...
   *Correcta: B. void indica que el método no devuelve ningún valor al terminar su ejecución.*
...
2. ¿Qué es un parámetro de un método?
   ...
   *Correcta: B. Los parámetros son los datos de entrada que recibe un método al ser invocado.*
...
3. ¿Qué es la sobrecarga de métodos (overload)?
   ...
   *Correcta: A. La sobrecarga permite varios métodos con el mismo nombre, si difieren en el número o tipo de parámetros.*
...
4. ¿Qué instrucción se usa para devolver un valor desde un método?
   ...
   *Correcta: B. return finaliza la ejecución del método y devuelve el valor indicado.*
...
5. ¿Qué es el ámbito (scope) de una variable local?
   ...
   *Correcta: B. Una variable local solo existe dentro del bloque en el que se declara.*
...
6. ¿Por qué conviene extraer código repetido a un método?
   ...
   *Correcta: B. Modularizar en métodos evita duplicar código y facilita corregirlo en un único lugar.*
...
7. public static double calcularValorTotal(...) ¿qué tipo de dato devuelve?
   ...
   *Correcta: C. El tipo indicado antes del nombre del método (double) es el que devuelve.*
...
8. ¿Qué palabra clave indica que un método pertenece a la clase y no a un objeto concreto?
   ...
   *Correcta: B. static indica que el método pertenece a la clase en sí, invocable sin crear un objeto.*
...
9. ¿Qué ocurre si se llama a un método con menos parámetros de los que espera?
   ...
   *Correcta: B. Si la llamada no coincide con ninguna firma del método, el código no compila.*
...
10. ¿Qué significa que los tipos primitivos se pasen "por valor" a un método?
   ...
   *Correcta: A. Con tipos primitivos, el método trabaja sobre una copia; los cambios no afectan a la variable original.*
...
11. ¿Qué ventaja aporta dividir el programa en métodos con una responsabilidad concreta?
   ...
   *Correcta: B. Dividir el programa en métodos con una única responsabilidad facilita su lectura y mantenimiento.*
...
1. ¿Qué es una clase en programación orientada a objetos?
   ...
   *Correcta: B. La clase es el "molde" a partir del cual se crean los objetos (instancias).*
...
2. ¿Qué es un objeto?
   ...
   *Correcta: A. Un objeto es una instancia concreta, creada a partir de una clase, con sus propios valores.*
...
3. ¿Qué es un constructor?
   ...
   *Correcta: A. El constructor se ejecuta automáticamente al crear (instanciar) un objeto.*
...
4. ¿Qué palabra clave se usa para crear un nuevo objeto en Java?
   ...
   *Correcta: B. La palabra clave new invoca el constructor y crea una nueva instancia.*
...
5. ¿Qué es la encapsulación?
   ...
   *Correcta: A. La encapsulación protege los atributos (normalmente private) y controla su acceso.*
...
6. ¿Para qué sirve un método getter?
   ...
   *Correcta: B. Un getter devuelve el valor actual de un atributo, normalmente privado.*
...
7. ¿Qué modificador de acceso se usa habitualmente para proteger los atributos de una clase?
   ...
   *Correcta: B. private impide el acceso directo al atributo desde fuera de la clase.*
...
8. ¿Para qué se sobrescribe el método toString()?
   ...
   *Correcta: B. Sobrescribir toString() personaliza el texto que se muestra al imprimir un objeto.*
...
9. ¿Qué hace this dentro de un constructor?
   ...
   *Correcta: A. this se refiere al propio objeto, útil para diferenciar un atributo de un parámetro homónimo.*
...
10. ¿Qué anotación indica que un método sobrescribe uno de la clase base?
   ...
   *Correcta: A. @Override indica al compilador que ese método sobrescribe uno heredado.*
...
11. ¿Qué contendrá un ArrayList<Producto> tras añadir varios objetos Producto?
   ...
   *Correcta: B. Un ArrayList<Producto> almacena referencias a objetos completos.*
...
12. ¿Qué ventaja tiene una clase Producto frente a las listas paralelas de la UT4?
   ...
   *Correcta: A. Cada objeto Producto agrupa sus propios datos, evitando que las listas paralelas se desincronicen.*
...
13. ¿Qué método llamarías para conocer el valor total de existencias (precio × stock) de un Producto?
   ...
   *Correcta: A. Definir getValorTotal() en la propia clase permite que cada objeto calcule su valor total.*
...
1. ¿Qué es la herencia en programación orientada a objetos?
   ...
   *Correcta: B. La herencia permite que una subclase reutilice y amplíe atributos y métodos de una superclase.*
...
2. ¿Qué palabra clave se usa en Java para heredar de otra clase?
   ...
   *Correcta: B. extends se utiliza para indicar que una clase hereda de otra.*
...
3. ¿Qué hace super() dentro de un constructor?
   ...
   *Correcta: A. super() invoca el constructor de la clase de la que se hereda.*
...
4. ¿Qué es sobrescribir (@Override) un método?
   ...
   *Correcta: B. Sobrescribir significa dar, en la subclase, una implementación distinta a un método que ya existía en la superclase.*
...
5. Si TarjetaGrafica hereda describir() de ComponenteInformatico y no lo sobrescribe, ¿qué versión se ejecuta al llamarlo?
   ...
   *Correcta: A. Si una subclase no sobrescribe un método heredado, se ejecuta la implementación de la superclase.*
...
6. ¿Qué es el polimorfismo?
   ...
   *Correcta: A. El polimorfismo permite tratar distintos objetos de forma uniforme, aunque cada uno responda distinto.*
...
7. Al llamar a describir() sobre elementos de ArrayList<ComponenteInformatico>, ¿qué ocurre?
   ...
   *Correcta: B. Gracias al polimorfismo, se ejecuta la versión sobrescrita (o heredada) correspondiente a la clase real de cada objeto.*
...
8. ¿Cuántas superclases directas puede tener una clase en Java?
   ...
   *Correcta: B. Java solo permite herencia simple: una clase puede extender, como máximo, una única superclase.*
...
9. ¿Por qué los atributos de ComponenteInformatico se declaran protected en vez de private?
   ...
   *Correcta: A. protected permite que las subclases accedan a esos atributos heredados directamente, a diferencia de private.*
...
10. ¿Qué ventaja aporta anotar un método con @Override?
   ...
   *Correcta: B. @Override ayuda a detectar errores: si el método no coincide con uno de la superclase, el compilador lo señala.*
...
11. ¿Qué representa la relación "TarjetaGrafica es un ComponenteInformatico"?
   ...
   *Correcta: A. Cuando una subclase hereda de una superclase, mantiene una relación "es-un" con ella.*
...
12. ¿Qué ocurre si TarjetaGrafica y MemoriaRAM sobrescriben describir() cada una a su manera?
   ...
   *Correcta: B. Cada subclase puede dar su propia versión de un método heredado, ajustada a sus propios atributos, sin ningún conflicto.*
...
13. ¿Qué ventaja aporta el polimorfismo al recorrer ArrayList<ComponenteInformatico>?
   ...
   *Correcta: A. El mismo código de recorrido sirve para cualquier subclase, sin distinguir el tipo concreto de cada objeto.*
...
1. ¿Qué es una excepción en Java?
   ...
   *Correcta: B. Una excepción representa una situación anómala que interrumpe el flujo normal de ejecución.*
...
2. ¿Qué bloque se usa para capturar una excepción?
   ...
   *Correcta: A. El bloque try-catch permite intentar ejecutar un código y capturar la excepción si se produce.*
...
3. ¿Qué excepción se lanza si se intenta leer un entero con nextInt() y el usuario escribe texto?
   ...
   *Correcta: B. Scanner lanza InputMismatchException cuando el dato leído no coincide con el tipo esperado.*
...
4. ¿Qué código se ejecuta siempre, haya o no excepción, si se usa finally?
   ...
   *Correcta: A. El bloque finally se ejecuta siempre, se produzca o no una excepción.*
...
5. ¿Cómo se crea una excepción personalizada en Java?
   ...
   *Correcta: B. Una excepción personalizada se define como una clase propia que extiende de Exception.*
...
6. ¿Qué instrucción se usa para lanzar una excepción manualmente?
   ...
   *Correcta: A. throw se usa para lanzar una excepción de forma explícita desde el código.*
...
7. ¿Por qué conviene validar los datos introducidos por el usuario?
   ...
   *Correcta: A. Validar la entrada evita errores en tiempo de ejecución y mejora la robustez del programa.*
...
8. ¿Qué es Javadoc?
   ...
   *Correcta: A. Javadoc genera documentación en HTML a partir de comentarios especiales (/** ... */).*
...
9. ¿Qué ayuda más a que otra persona entienda el código de GestorInventario?
   ...
   *Correcta: A. Unos nombres descriptivos y comentarios bien situados facilitan entender y mantener el código.*
...
10. Al finalizar la UT8, ¿qué reúne ya el proyecto GestorInventario?
   ...
   *Correcta: B. El proyecto ha ido incorporando, UT a UT, todos los contenidos del módulo.*
