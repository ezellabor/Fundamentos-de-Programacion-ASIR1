...
|---|---|
| 🟠 **IntelliJ IDEA Community** (*Recomendada*) | Úsala salvo que tengas un motivo para no hacerlo. Instalación que detecta el JDK automáticamente y da mensajes de error más claros. |
